...
namespace App\Pro\Controller\Admin\Scheduler;
...
/**
 * @extends AbstractCrudController<Run>
 */
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextEditorField::new('input')
                ->setTemplatePath('pro/admin/scheduler/run_crud/fields/input.html.twig')
                ->hideOnIndex(),
            TextEditorField::new('failureOutput')
                ->setTemplatePath('pro/admin/scheduler/run_crud/fields/failure_output.html.twig')
                ->hideOnIndex(),
