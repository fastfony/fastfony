 ...
 * }
 * @psalm-type FastfonyLicenseConfig = array{
 ...
 *         dirs?: list<scalar|null|Param>,
 *         excluded_dirs?: list<scalar|null|Param>,
 *         excluded_names?: list<scalar|null|Param>,
 *         external_translations_dirs?: list<scalar|null|Param>,
 *         output_format?: scalar|null|Param, // Default: "xlf"
 *         blacklist_domains?: list<scalar|null|Param>,
 *         whitelist_domains?: list<scalar|null|Param>,
 *         remote_storage?: list<scalar|null|Param>,
 *         local_storage?: list<scalar|null|Param>,
 *         output_dir?: scalar|null|Param, // Default: "%kernel.project_dir%/Resources/translations"
 *         project_root?: scalar|null|Param, // The root dir of your project. By default this will be kernel_root's parent.
 *         xliff_version?: scalar|null|Param, // The version of XLIFF XML you want to use (if dumping to this format). // Default: "2.0"
 *         new_message_format?: scalar|null|Param, // Use "icu" to place new translations in "{domain}+intl-icu.{locale}.{ext}" container // Default: "icu"
 ...
 *         enabled?: bool|Param, // Default: false
 *         config_name?: scalar|null|Param, // Default: "default"
 *         activator?: scalar|null|Param, // Default: "Translation\\Bundle\\EditInPlace\\Activator"
 *         show_untranslatable?: scalar|null|Param, // Default: true
 *     },
 *     webui?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         allow_create?: bool|Param, // Default: true
 *         allow_delete?: bool|Param, // Default: true
 *         file_base_path?: scalar|null|Param, // Base path for SourceLocation's. Defaults to "%kernel.project_dir%". // Default: null
 *     },
 *     locales?: list<scalar|null|Param>,
 *     default_locale?: scalar|null|Param, // Your default language or fallback locale. Default will be kernel.default_locale
 *     symfony_profiler?: array{ // Extend the debug profiler with information about requests.
 ...
 *         config_name?: scalar|null|Param, // Default: "default"
 *     },
 *     http_client?: scalar|null|Param, // Default: "httplug.client"
 *     message_factory?: scalar|null|Param, // Default: "httplug.message_factory"
 * }
 ...
 *     vue?: VueConfig,
 *     turbo?: TurboConfig,
 *     fastfony_license?: FastfonyLicenseConfig,
